  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#6366F1] to-[#8B5CF6] flex items-center justify-center p-6">
      ...
      <div className="w-full max-w-2xl relative">
        ...
        <Card className="bg-[#1F1F1F] border-white/10 shadow-2xl mb-8 animate-fade-in-up animation-delay-400">
          <CardHeader>
        ...
        {/* Next steps */}
        <Card className="bg-[#1F1F1F] border-white/10 shadow-2xl mb-8 animate-fade-in-up animation-delay-600">
          <CardHeader>
